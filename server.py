...
class ServerGUI:
    def __init__(self, master):
        ...
        self.port_e = tk.Entry(master); self.port_e.insert(0, "5000")
        ...
        tk.Label(master, text="Gelen Şifreli Mesaj").grid(row=4, column=0, sticky='w')
        self.raw_txt = st.ScrolledText(master, height=6)
        self.raw_txt.grid(row=4, column=1, sticky='we')

        tk.Label(master, text="Deşifrelenmiş Mesaj").grid(row=5, column=0, sticky='w')
